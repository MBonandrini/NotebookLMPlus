export const APP_VERSION = '0.5.0-hardened';
...
export function mergeSettings(saved = {}) {
  ...
  return {
    ...
    ollama: {
      ...
      requestTimeoutSeconds: Math.round(clampFinite(ollamaRaw.requestTimeoutSeconds, 5, 600, base.ollama.requestTimeoutSeconds)),
    },
    retrieval: {
      ...base.retrieval,
      chunkSize,
