# NotebookLM+ v0.5.1 Hardened QA Report
...
- 27 application-contract tests
- GitHub Pages static-server smoke test
- direct TXT parse + chunk smoke test

Total: **61 automated tests plus deployment and parser smoke checks**.
...
- mixed-build startup crashes caused by cached HTML/JavaScript from different releases;
- automatic build-version handshake, cache/service-worker recovery, and versioned entry assets;
