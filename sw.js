const CACHE = 'notebooklmplus-v0.5.1';
const SHELL = [
  './', './index.html', './css/styles.css?v=0.5.1', './manifest.webmanifest',
  './js/app.js?v=0.5.1', './js/config.js', './js/db.js', './js/utils.js', './js/progress.js',
