const CACHE = 'notebooklmplus-v0.6.0';
const SHELL = [
  './', './index.html', './css/styles.css?v=0.6.0', './manifest.webmanifest',
  './js/app.js?v=0.6.0', './js/config.js', './js/db.js', './js/utils.js', './js/progress.js',
  './js/ai.js', './js/ollama.js', './js/parsers.js', './js/chunking.js', './js/retrieval.js', './js/indexer.js',
  './js/sources.js', './js/source_tree.js', './js/markdown.js'
];
